...
import learningImage from "../../assets/images/banner/Learn_on_table_white.svg";
      ...
      >
        <div className=" mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Học Cấu trúc dữ liệu và Giải thuật khó ?</h1>
